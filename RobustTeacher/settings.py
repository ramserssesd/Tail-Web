"""
Django settings for RobustTeacher project.
...
SECRET_KEY = 'django-insecure-+hd#1zlvgm7$v664%x_u42i-9njf9oj+wkal%-zz6)rj^a0x=='
...
ROOT_URLCONF = 'RobustTeacher.urls'
...
WSGI_APPLICATION = 'RobustTeacher.wsgi.application'
